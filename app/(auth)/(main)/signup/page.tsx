	...
	return (
		<form className="p-6 md:p-8">
			<FieldGroup>
				...
				<Field>
					<FieldLabel htmlFor="username" className="cursor-none">
						Username
					</FieldLabel>
					<Input id="username" type="text" placeholder="aditsuru" required className="cursor-none" />
					<FieldDescription>You cannot change this again.</FieldDescription>
				</Field>
				<Field>
					<FieldLabel htmlFor="email" className="cursor-none">
						Email
					</FieldLabel>
					<Input id="email" type="email" placeholder="adi@example.com" required className="cursor-none" />
				...
				<Field>
					<Field className="grid grid-cols-2 gap-4">
						<Field>
							...
							<Input id="password" type="password" required className="cursor-none" />
						</Field>
						<Field>
							<FieldLabel htmlFor="confirm-password" className="cursor-none">
								Confirm Password
							</FieldLabel>
							<Input id="confirm-password" type="password" required className="cursor-none" />
						</Field>
					</Field>
					<FieldDescription>Must be at least 8 characters long.</FieldDescription>
				</Field>
				<Field>
					<Button type="submit" className="cursor-none">
						Create Account
					</Button>
				</Field>
